...
register_nav_menus(
	array(
		'main-nav'		=> __( 'The Main Menu', 'modern-wp-theme' ),		// Main nav in header
		'offcanvas-nav'	=> __( 'The Off-Canvas Menu', 'modern-wp-theme' ),	// Off-Canvas nav
		'footer-links'	=> __( 'Footer Links', 'modern-wp-theme' )			// Secondary nav in footer
	)
);
